...
6. [Query Results & CSV Downloads](#query-results--csv-downloads)
...
- **Query CSV Download**: [Member vs Casual Rider Count](https://github.com/EXECiiAA/png-files/blob/main/Member%20vs%20Casual%20Rider%20Count_.csv)

![Member Vs Casual Rider Count](https://github.com/EXECiiAA/png-files/blob/main/Member%20Vs%20Casual%20Rider%20Count.png)

---

### Null Values in `start_station_name`
- Null rates were significantly higher for members (549,587 rows) than casual riders (326,129 rows), which may impact visualizations related to stations.
- **Query CSV Download**: [Start Station Nulls](https://github.com/EXECiiAA/png-files/blob/main/start_station_nulls.csv)

---

### Station Usage
- Casual riders accessed more unique stations (1,549) compared to members (1,455), reflecting dispersed travel patterns.
- **Query CSV Download**: [Member vs Casual Station Count](https://github.com/EXECiiAA/png-files/blob/main/Member%20vs%20Casual%20Station%20Count_.csv)

![Station Count by Rider Type](https://github.com/EXECiiAA/png-files/blob/main/Station%20Count%20by%20Rider%20Type.png)

---

## Query Results & CSV Downloads
For transparency and further analysis, the following query results are available:

| Query Description | CSV File |
|-------------------|----------|
| Rider Count by Membership Type | [Member vs Casual Rider Count](https://github.com/EXECiiAA/png-files/blob/main/Member%20vs%20Casual%20Rider%20Count_.csv) |
| Null Values in `start_station_name` | [Start Station Nulls](https://github.com/EXECiiAA/png-files/blob/main/start_station_nulls.csv) |
| Unique Stations by Membership Type | [Member vs Casual Station Count](https://github.com/EXECiiAA/png-files/blob/main/Member%20vs%20Casual%20Station%20Count_.csv) |
